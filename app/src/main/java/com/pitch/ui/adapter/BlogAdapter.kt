...
class BlogAdapter(private val click: (model: HomeModel, position: Int) -> Unit) :
    ListAdapter<HomeModel, BlogAdapter.MyViewHolder>(DiffUtills()) {

    class MyViewHolder(val binding: BlogRowLayoutBinding) : RecyclerView.ViewHolder(binding.root)
